...
const BikeSlider = () => {
    ...
    const isSmDown = useMediaQuery(theme.breakpoints.down('md')); // Check for small screens

    const settings = {
        dots: false,
        infinite: true,
        speed: 500,
        slidesToShow: 1, // Default for all screens
        slidesToScroll: 1,
        arrows: false,
        responsive: [
            {
                breakpoint: 600, // Screens less than 600px (sm and below)
                settings: {
                    slidesToShow: 1,
                },
            },
            {
                breakpoint: 960, // Screens less than 960px (md and below)
                settings: {
                    slidesToShow: 2,
                },
            },
