                ...
                <Box sx={{ width: "100%" }}>
                    ...
                    <Grid container spacing={3} alignItems="center">
                        ...
                        <Grid item xs={12} md={6} sx={{ mt: { xl: -10, lg: -6 } }}>
                            <Typography
                                sx={{ fontWeight: "700", color: '#1E1E1E', marginBottom: 3, fontSize: { xl: 32, lg: 32, md: 30, sm: 25, xs: 20 }, fontFamily: '"Nunito", sans-serif' }}
                            >
                            ...
                            <Typography
                                variant="body1"
                                sx={{ marginBottom: 2, textAlign: "justify", color: '#1E1E1E', fontWeight: "600", fontFamily: '"Nunito", sans-serif' }}
                            >
                            ...
                            <Typography
                                variant="body1"
                                sx={{ textAlign: "justify", color: '#1E1E1E', fontFamily: '"Nunito", sans-serif', fontWeight: "600" }}
                            >
