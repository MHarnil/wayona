...
import Razor from '../../assest/img/home/RazorBike.webp';
        ...
        <Box sx={{ backgroundColor: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", my: 6, }}>
            ...
            <Grid container spacing={2} alignItems="center" justifyContent="space-between">
                ...
                <Grid item xs={12} sm={3} textAlign="center" sx={{ ml: 5 }}>
                    <Typography variant="body2" sx={{ fontFamily: '"Nunito", sans-serif', color: '#000', fontWeight: 600, fontSize: 20 }} className="animate-text" >
                        One Charge And Get Up To
                    </Typography>
                    <Typography variant="h3" fontWeight="bold" sx={{ mt: 1, color: '#FB7C00', fontFamily: '"Nunito", sans-serif' }} className="animate-text"  >
